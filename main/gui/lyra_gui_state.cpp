...
bool s_use_24_hour = true;
bool s_dst_enabled = false;
...
uint32_t s_saved_playback_position_ms = 0;
bool s_saved_playback_position_pending = false;
...
ClockInputKind s_clock_input_kind = ClockInputKind::Time;
char s_clock_input_digits[9] = "0000";
size_t s_clock_input_cursor = 0;
bool s_clock_input_pm = false;
